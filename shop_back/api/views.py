...
def product_list(request):
    ...
    products_list = list(products.values())  # we cannot serialize QuerySet, so we convert it to list
...
def category_products(request, id):
    ...
    products = category.products.all()  # we can use related_name to get all the products associated with this category
